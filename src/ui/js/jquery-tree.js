    ...
    init: function( box, options ) {
      ...
      $( this.contents ).delegate( "a", {
        contextmenu: function( e ) {
          if ( that.userOptions.onContextmenu ) return that.userOptions.onContextmenu.bind( this )( e );
        },
        click: function( e ) {
          if ( !that.isLeaf( this ) ) {
            that.toggle( this );
      ...
      if ( options.dnd ) {
        var drag = {
          ...
          updateChildrenIndext: function( ul, gap ) {
            ...
            real_ul.setAttribute( "data-deep", Number( real_ul.parentNode.parentNode.getAttribute( "data-deep" ) ) + 1 );
            var lis = ul.children,
