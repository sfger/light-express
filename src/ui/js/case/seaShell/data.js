define( function () {
  return [
    ...
    //Blog{{{
    {
      name: '个人博客、社区',
      children: [
        { name: 'kangax', url: 'https://kangax.github.io/' },
        ...
        { name: 'DemoDaShi', url: 'http://www.demodashi.com/' },
        { name: 'LeaVerou', url: 'http://lea.verou.me/' },
        { name: '九章算法', url: 'http://www.jiuzhang.com/', target: "_blank" },
        { name: '阮一峰', url: 'http://www.ruanyifeng.com/blog/', target: "_blank" },
        { name: '张鑫旭', url: 'http://www.zhangxinxu.com' },
        { name: 'dpfblog', url: 'http://www.dpfblog.com/' },
    ...
    //UI{{{
    {
      ...
      children: [
        ...
        { name: 'Popper.js', url: 'https://github.com/FezVrasta/popper.js' },
        { name: 'force.js', url: 'https://github.com/gravmatt/force-js' },
        { name: 'easings', url: 'http://easings.net/zh-cn' },
        ...
        { name: 'Impress', url: 'https://github.com/impress/impress.js' },
        { name: 'MessengerJS', url: 'https://github.com/biqing/MessengerJS' },
    ...
    //Software{{{
    {
      ...
      children: [
        ...
        { name: 'PHP', url: 'http://www.php.net', target: '_blank' },
    ...
    //Tools{{{
    {
      ...
      children: [
        ...
        { name: 'DocSearch', url: 'https://github.com/algolia/docsearch' },
        { name: 'REPL', url: 'https://jscomplete.com/repl' },
        ...
        { name: '百度浏览器统计', url: 'http://tongji.baidu.com/data/browser' }
      ]
    },
    //}}}
    //Tech{{{
