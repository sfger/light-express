      ...
      pagination.prototype = {
        ...
        initEvent: function() {
          ...
          render.children[ 1 ].children[ 0 ].onsubmit = function() {
            ...
            if ( a > that.pageCount ) window.getElementsByClassName( "page", render )[ 0 ].value = that.pageCount;
            else if ( a < 1 ) window.getElementsByClassName( "page", render )[ 0 ].value = 1;
            if ( isNaN( a ) ) a = 1;
            if ( options.useAjax ) {
              options.pageNumber = Number( a );
              if ( options.onChangePage ) options.onChangePage.call( that, options.pageNumber, that.pageCount );
